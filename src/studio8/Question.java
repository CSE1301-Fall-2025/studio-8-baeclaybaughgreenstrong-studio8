...
public class Question {
	...
	public static void main(String[] args) {
		// Create a Question object of your own!
		Question q1 = new Question("what does the fox say?" , "ringdingdingdingring" , 10);
		System.out.println(q1.checkAnswer("ringdingdingdingring"));
	}
}
